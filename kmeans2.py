...
# 读取数据
#def getData():
#    iris = pd.read_csv('iris_train_shuzhi.csv',header = None,names=["Sepal.Length","Sepal.Width","Petal.Length","Petal.Width","species"])
...
def getData():
    # 加载数据
    data = pd.read_csv('iris_train_shuzhi.csv')
    # 提取特征和标签
